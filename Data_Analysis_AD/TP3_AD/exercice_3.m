...
V_3D = cat(3,V_chrysanthemes, V_oeillets, V_pensees);
[~, code_classe] = max(V_3D,[],3);
...
[V_oeillets, denominateur_oeillets] = vraisemblance(X_pensees(:,1)', X_pensees(:,2)', mu_oeillets, Sigma_oeillets, -1);
[V_chrysanthemes, denominateur_oeillets] = vraisemblance(X_pensees(:,1)', X_pensees(:,2)', mu_oeillets, Sigma_oeillets, -1);
